                    ...
                    <div className="base-grid">
                        ...
                        <div className="chart-wrapper">
                            <div className="chart-box">
                                ...
                                <p className={`p3 ${chartBox[0].color}`}>{chartBox[0].paragraph}</p>
                            </div>
                            <div className="chart-box">
                                <h3>{chartBox[1].statistic}<span>%</span></h3>
                                <p className="p3">{chartBox[1].paragraph}</p>
                            </div>
                            <div className="chart-box">
                                <h3>{chartBox[2].statistic}<span>%</span></h3>
                                <p className="p3">{chartBox[2].paragraph}</p>
                            </div>
